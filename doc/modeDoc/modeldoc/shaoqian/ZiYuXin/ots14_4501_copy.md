# 模型索引：闪电（少女前线）- 换装 4501（副本）

## 1. 概览
- **文档 ID**：`ots14_4501_copy`
- **来源**：少女前线
...
- **名称**：闪电
- **原作**：少女前线
- **本地模型目录**：`/Users/fengfan/Documents/mode/model/shaoqian/ZiYuXin/ots14_4501`
...
## 6. Agent 提示词（可直接用）
```markdown
你是少女前线的「闪电」。你当前使用的换装为「换装 4501（副本）」（ots14_4501_copy）。
