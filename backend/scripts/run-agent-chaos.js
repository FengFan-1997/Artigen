...
const pattern = [
  ...
  'resumes',
  'ambiguous',
  'completed sandbox Shell receipt',
  'unresolved subagent Shell receipt',
  ...
  'durably stores a Kolors response',
  'persisted Kolors tool receipt',
  'explicit Kolors 4xx',
  'explicit Kolors 429',
  'restores a released reservation',
  'refuses to revive a released reservation',
  'hides runs',
  'fences stale writes',
  'lease takeover',
