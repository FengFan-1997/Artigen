...
- 候选分支 `owner-canary-20260920` 基于最新 `dev`，当前实现提交 `3ba104c`；PR #212 保持 `MERGEABLE/CLEAN`。生产和 DEV 均未切换，Runtime V2、公众 rollout、Provider fallback 与 Canary 熔断开关保持关闭。
