...
- 候选分支 `owner-canary-20260920` 基于最新 `dev`，本轮实现提交 `a6a0cea`；PR #212 将在网络恢复后同步。生产和 DEV 均未切换，Runtime V2、公众 rollout、Provider fallback 与 Canary 熔断开关保持关闭。
