...
.execution-card > header { display: flex; align-items: center; gap: 12px; padding: 16px 18px; border-bottom: 1px solid var(--border); background: var(--surface-raised); }
...
.status-chip { display: inline-flex; align-items: center; gap: 7px; margin-left: auto; padding: 6px 9px; border: 1px solid var(--border); border-radius: 999px; font-size: 11px; font-weight: 780; background: var(--surface); }
...
.execution-meta span { display: flex; gap: 6px; padding: 6px 8px; border: 1px solid var(--border); border-radius: 8px; color: var(--muted); font-size: 11px; background: var(--surface); }.execution-meta b { color: var(--text); }
...
.budget-block { justify-content: space-between; border-color: color-mix(in srgb,var(--warning) 55%,var(--border)); background: color-mix(in srgb,var(--warning) 7%,var(--surface)); }.budget-block div { display: grid; gap: 3px; }.budget-block b { font-size: 12px; }.budget-block span { color: var(--muted); font-size: 11px; }.budget-block a { color: var(--text); font-size: 12px; font-weight: 800; }
...
/* Execution appears as a production proof strip, not another nested dashboard card. */
.execution-card { position: relative; border-color: var(--border-strong,var(--border)); border-radius: 6px; background: var(--surface); box-shadow: none; }
.execution-card::before { position: absolute; top: 0; bottom: 0; left: 0; z-index: 2; width: 2px; background: var(--acid); content: ''; }
.execution-card > header { padding: 15px 18px 15px 20px; background: transparent; }
.executor-icon { position: relative; width: 30px; height: 30px; border-color: var(--text); border-radius: 50%; color: transparent; background: var(--surface); }
.executor-icon::before,.executor-icon::after { position: absolute; top: 50%; left: 50%; background: var(--text); content: ''; transform: translate(-50%,-50%); }.executor-icon::before { width: 38px; height: 1px; }.executor-icon::after { width: 1px; height: 38px; }.executor-icon svg { display: none; }
header p { margin-bottom: 3px; color: var(--muted); font-size: 12px; font-weight: 600; letter-spacing: 0; text-transform: none; }header h3 { font-size: 15px; font-weight: 680; }
.status-chip { border: 0; border-radius: 4px; font-size: 12px; background: var(--surface-raised); }.status-chip i { border-radius: 0; }
.execution-body { padding: 20px; }.plan-step { grid-template-columns: 26px 1fr; min-height: 48px; }.plan-step > span { width: 24px; height: 24px; border-radius: 0; font-size: 12px; }.plan-step:not(:last-child)::after { left: 11px; }.plan-step p { margin-top: 3px; font-size: 14px; text-align: left; }
.execution-meta { gap: 0; margin-top: 14px; border-top-color: var(--border-strong,var(--border)); }.execution-meta span { padding: 9px 12px 9px 0; border: 0; border-right: 1px solid var(--border); border-radius: 0; font-size: 12px; background: transparent; }.execution-meta span + span { padding-left: 12px; }
.local-note,.upload-note,.budget-block,.failure-block { border-radius: 5px; }.local-note b,.upload-note b,.budget-block b,.failure-block b { font-size: 13px; }.local-note span,.upload-note span,.budget-block span,.failure-block span { font-size: 12px; }
.deliverables > p { font-size: 12px; letter-spacing: 0; text-transform: none; }.deliverables > a { border-radius: 4px; }.deliverables span { font-size: 12px; }
.approval-card { border-color: color-mix(in srgb,var(--warning) 46%,var(--border)); border-radius: 5px; background: var(--surface); }.approval-kicker { font-size: 12px; letter-spacing: 0; text-transform: none; }.approval-card p { font-size: 13px; }.approval-actions button,.approval-card a { border-radius: 5px; font-size: 12px; }.approval-actions button:first-child,.approval-card a { border-color: var(--primary,var(--text)); color: var(--primary-ink,var(--bg)); background: var(--primary,var(--text)); }.approval-actions .session { color: var(--text); background: transparent; }
.execution-card > footer { padding: 0 20px 17px; }.footer-actions > span,.footer-actions button,.footer-actions a { font-size: 12px; }.footer-actions button,.footer-actions a { border-radius: 5px; }.footer-actions .primary { border-color: var(--primary,var(--text)); color: var(--primary-ink,var(--bg)); background: var(--primary,var(--text)); }
