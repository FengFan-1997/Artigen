...
class LAppLive2DManager {
  ...
  tapEvent(x, y) {
    ...
    if (this.model.hitTest(LAppDefine.HIT_AREA_HEAD, x, y)) {
      ...
      // User requested to disable "squish" motion on click.
      // Only trigger if specifically desired, otherwise just log or small reaction.
      // this.model.startRandomMotion(LAppDefine.MOTION_GROUP_TAP_BODY, LAppDefine.PRIORITY_NORMAL);
      this.model.startRandomMotion(LAppDefine.MOTION_GROUP_SHAKE, LAppDefine.PRIORITY_NORMAL);
    }
    return true;
  }
}
