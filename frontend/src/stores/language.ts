...
const translations = {
  en: {
    login: {
      ...
      choose_method_hint_without_google: 'Email code or account password login',
      ...
      sub: 'Use a 6-digit code sent to your email',
      ...
      account_sub: 'Current signed-in account',
      user_id: 'USER_ID',
      ...
      verify_hint: 'Successful verification creates a secure sign-in session',
  ...
  zh: {
    login: {
      ...
      choose_method_hint_without_google: '支持邮箱验证码或账号密码登录',
